...
#define SE_FORMAT_SU 0
#define SE_FORMAT_SEGY 1
#define SE_FORMAT_BIN 2

#define SE_LITTLE_ENDIAN 0
#define SE_BIG_ENDIAN 1

#define SE_SHOT_GATHER 0
#define SE_SUPER_GATHER 1
#define SE_OFFSET_GATHER 2

#define MAX_NTR 999999999
...
//     CUBE_TYPE_UNKNOWN,  
//     CUBE_TYPE_MH,   /**< CDP/Offset */
//     CUBE_TYPE_HM,   /**< Signed offset/CDP */
//     CUBE_TYPE_SR,   /**< Shot/Receiver */
//     CUBE_TYPE_RS,   /**< Receiver/Shot */
//     CUBE_TYPE_HS,   /**< signed offset/Shot */
//     CUBE_TYPE_OAS,  /**< absolute offset/azimuth/shot */ //绝对 offset/azimuth/shot
//     CUBE_TYPE_ZXYO, /**< image cube depth, x, y, offset  */  //图像立方体z,x,y,offset
//     CUBE_TYPE_ZOXY, /**< image cube depth, offset, x, y  */  //图像立方体z,offset,x,y
//     CUBE_TYPE_TXY, /**< image cube time, x, y  */ //图像立方体time, x, y
//     CUBE_TYPE_TXYO, /**< image cube time, x, y, offset  */  //图像立方体t, x, y, offset
//     CUBE_TYPE_TOXY, /**< image cube time, offset, x, y  */  //图像立方体t, offset, x, y
//     CUBE_TYPE_XiEtaTau,  /**< image cube x, y, time  */   //图像立方体 x, y, t
//     CUBE_TYPE_TauXiEta,  /**< image cube time, x, y */  //图像立方体t, x, y
//     CUBE_TYPE_NPA,  /**< image cube normal, polar angle, azimuth angle */ //图像立方体 normal, polar angle, azimuth angle
// } cube_type;
...
typedef struct
{
	double m[4]; /**< array storing the matrix using the packing :
				 \verbatim
				 [ m[0] m[1] ]
				 [ m[2] m[3] ]
				 \endverbatim */
...
// /** 5D regulary sampled cube. */
// typedef struct {
//     int64_t n1; /**< number of points in 1st dimension */
//     int64_t n2; /**< number of points in 2nd dimension */
//     int64_t n3; /**< number of points in 3rd dimension */
//     int64_t n4; /**< number of points in 4th dimension */
//     int64_t n5; /**< number of points in 5th dimension */
//     double  d1; /**< point spacing ind 1st dimension */
//     double  d2; /**< point spacing ind 2nd dimension */
//     double  d3; /**< point spacing ind 3rd dimension */
//     double  d4; /**< point spacing ind 4th dimension */
//     double  d5; /**< point spacing ind 5th dimension */
//     double  o1; /**< origin of the 1st dimension */
//     double  o2; /**< point spacing ind 2nd dimension */
//     double  o3; /**< point spacing ind 3rd dimension */
//     double  o4; /**< point spacing ind 4th dimension */
//     double  o5; /**< point spacing ind 5th dimension */
//     cube_type cube_type; /**< type of cube */
// } cube_t;

// /** vector index for 5D cube. */  //向量索引
// typedef struct {
//     int64_t i1; /**< index for the 1st dimension */
//     int64_t i2; /**< index for the 2nd dimension */
//     int64_t i3; /**< index for the 3rd dimension */
//     int64_t i4; /**< index for the 4th dimension */
//     int64_t i5; /**< index for the 5th dimension */
// } cube_vector_t;
...
typedef struct
{
	...
	float rf; //reference frequency
	float rv; //reference velocity
